...
public class BaIdQueryResult {
	...
	private BaIdQueryServiceItems services;
	...
	public BaIdQueryServiceItems getServices() {
		return services;
	}

	public void setServices(BaIdQueryServiceItems services) {
