...
public class CRM_QueryByCitizenIDInstAddr {
	...
	@Element(required=false, name="InstAddr_Code")
	private String InstAddr_Code;
	...
	@Element(required=false, name="InstAddr_SerialNo")
	private String InstAddr_SerialNo;
	...
	@Element(required=false, name="InstAddr_SubDistrict_Code")
	private String InstAddr_SubDistrict_Code;
	@Element(required=false, name="InstAddr_SubDistrict_Name")
	private String InstAddr_SubDistrict_Name;
	@Element(required=false, name="InstAddr_District_Code")
	private String InstAddr_District_Code;
	@Element(required=false, name="InstAddr_District_Name")
	private String InstAddr_District_Name;
	@Element(required=false, name="InstAddr_Province_Code")
	private String InstAddr_Province_Code;
	...
	@Element(required=false, name="InstAddr_Country_Code")
	private String InstAddr_Country_Code;
	...
	public String getInstAddr_Code() {
		return InstAddr_Code;
	}
	public void setInstAddr_Code(String instAddr_Code) {
		InstAddr_Code = instAddr_Code;
	}
	...
	public String getInstAddr_SerialNo() {
		return InstAddr_SerialNo;
	}
	public void setInstAddr_SerialNo(String instAddr_SerialNo) {
		InstAddr_SerialNo = instAddr_SerialNo;
	}
	...
	public String getInstAddr_SubDistrict_Code() {
		return InstAddr_SubDistrict_Code;
	}
	public void setInstAddr_SubDistrict_Code(String instAddr_SubDistrict_Code) {
		InstAddr_SubDistrict_Code = instAddr_SubDistrict_Code;
	}
	...
	public String getInstAddr_District_Code() {
		return InstAddr_District_Code;
	}
	public void setInstAddr_District_Code(String instAddr_District_Code) {
		InstAddr_District_Code = instAddr_District_Code;
	}
	...
	public String getInstAddr_Province_Code() {
		return InstAddr_Province_Code;
	}
	public void setInstAddr_Province_Code(String instAddr_Province_Code) {
		InstAddr_Province_Code = instAddr_Province_Code;
	}
	...
	public String getInstAddr_Country_Code() {
		return InstAddr_Country_Code;
	}
	public void setInstAddr_Country_Code(String instAddr_Country_Code) {
		InstAddr_Country_Code = instAddr_Country_Code;
	}
